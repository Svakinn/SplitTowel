...
define('base/app',["require","exports","plugins/router","config","base/menuContainer","services/dataService","services/logger"],function(e,n,o,i,t,r,a){var u=function(){function e(){this.appTitle=ko.observable("Hot|Split Towel SPA"),this.isLoading=ko.computed(function(){return o.isNavigating()||r.ctx.isLoading()},this)}return e.prototype.boot=function(){var e=this;return a.logger.log("Hot Towel SPA Loaded!",null,"app",!0),o.on("router:route:not-found",function(){a.logger.logError("No Route Found",e,"app",!0)}),e.mainMenu=ko.observable(new t.MenuContainer("mainMenu")),Q.when(e.mainMenu().init(i.cfg.mainMenuItems,!1,"").then(function(){return o.makeRelative({moduleId:"viewmodels"}).map(i.cfg.routes).buildNavigationModel().activate()}))},e}();n.MainClass=u,n.cspMain=new u});
...
define('viewmodels/details',["require","exports","services/logger","services/dataService"],function(e,t,n,i){var r=function(){function e(){this.title=ko.observable(""),this.countries=ko.observableArray(),this.compTitle=ko.computed(function(){return this.title()+" (computed)"},this)}return e.prototype.clickUpdatTitle=function(e){this.title(e)},e.prototype.activateToolTips=function(){$(".toolTip").tooltip()},e.prototype.activate=function(){var e=this;return this.title("My title"),n.logger.log("Details View Activated",null,"details",!0),Q.when(i.ctx.getCountries(e.countries)).then(function(){return e.activateToolTips(),Q(!0)})},e.prototype.viewAttached=function(){this.activateToolTips()},e}();t.DetailsView=r,t.vm=new r,t.activate=function(){return t.vm.activate()},t.attached=function(e){t.vm.viewAttached(e)}});
define('viewmodels/home',["require","exports","services/logger"],function(e,t,n){var i=function(){function e(){this.title="Home View"}return e.prototype.activate=function(){return n.logger.log("We are at home now",null,"home",!0),!0},e}();t.ViewModel=i,t.vm=new i,t.activate=function(){return t.vm.activate()}});
