...
define('base/menuContainer',["require","exports"],function(e,t){var i=function(){function e(e){this.selectedItem=ko.observable(null),this.itemsList=ko.observableArray(),this.id=e}return e.prototype.selectItem=function(e){return this.selectedItem&&null!=this.selectedItem()&&this.selectedItem().id!=e.id&&this.selectedItem().isSelected(!1),e.isSelected(!0),this.selectedItem(e),!0},e.prototype.selectById=function(e){var t=ko.utils.arrayFirst(this.itemsList(),function(t){return t.id===e});t&&this.selectItem(t)},e.prototype.init=function(e,t,i){for(var n=new Array,o=0,r=e.length;r>o;o++){var s=e[o],a=ko.observable("");t&&a(s.toolTip),n.push({id:s.id,route:s.route,name:ko.observable(s.id),toolTip:a,isSelected:ko.observable(!1)})}return this.itemsList(n),i?this.selectById(i):null==this.selectedItem()&&this.itemsList().length>0&&this.selectItem(this.itemsList()[0]),Q(!0)},e}();t.MenuContainer=i});
define('services/logger',["require","exports","durandal/system"],function(e,t,n){var i=function(){function e(){}return e.prototype.log=function(e,t,n,i){this.logIt(e,t,n,i,"info")},e.prototype.logError=function(e,t,n,i){this.logIt(e,t,n,i,"error")},e.prototype.logIt=function(e,t,i,r,o){i=i?"["+i+"] ":"",t?n.log(i,e,t):n.log(i,e),r&&("error"===o?toastr.error(e):toastr.info(e))},e}();t.LoggerClass=i,t.logger=new i});
define('services/dataService',["require","exports","config","services/logger"],function(e,t,n,i){var r=function(){function e(){this.loadArray=ko.observableArray(),this.isLoading=ko.observable(!1),this.configBreezeManager()}return e.prototype.pushLoader=function(){this.loadArray.push("."),this.isLoading()||this.isLoading(!0)},e.prototype.popLoader=function(){this.loadArray.pop(),this.isLoading(this.loadArray().length>0)},e.prototype.configBreezeManager=function(){this.manager=new breeze.EntityManager(n.cfg.breezeServiceName),breeze.NamingConvention.none.setAsDefault()},e.prototype.handleExceptions=function(e,t){i.logger.logError(e.message,e,t,!0)},e.prototype.getCountries=function(e){function t(t){if(e&&t.results){var n=new Array,r=t.results.length;if(r>0)for(var o=0;r>o;o++)n.push({id:t.results[o].Id,name:t.results[o].Name,toolTip:t.results[o].ToolTip});e(n)}return console.log("Got our coutries"),i.popLoader(),Q(!0)}function n(e){return i.popLoader(),i.handleExceptions(e,"GetCountries"),Q(!1)}var i=this;i.pushLoader();var r=breeze.EntityQuery.from("GetCountries");return i.manager.executeQuery(r).then(t).fail(n)},e}();t.DataService=r,t.ctx=new r});
define('base/app',["require","exports","plugins/router","config","base/menuContainer","services/dataService","services/logger"],function(e,t,n,o,i,r,a){var u=function(){function e(){var e=this;this.appTitle=ko.observable("Hot|Split Towel SPA"),this.pageModuleId="",this.cfg=o.cfg,this.logger=a.logger,this.ctx=r.ctx,this.mainMenu=ko.observable(new i.MenuContainer("mainMenu")),this.isLoading=ko.computed(function(){return n.isNavigating()||e.ctx.isLoading()},this)}return e.prototype.navigateTo=function(e){var t=e;return"home"==t&&(t=""),n.navigate(t)},e.prototype.navigateToItem=function(e,t){var o=e+"/"+String(t);return n.navigate(o)},e.prototype.navigateToItemStr=function(e,t){var o=e+"/"+t;return n.navigate(o)},e.prototype.boot=function(){var e=this;e.logger.log("Hot Towel SPA Loaded!",null,"app",!0),n.on("router:route:not-found",function(){e.logger.logError("No Route Found",e,"app",!0)});var t=n.activeInstruction.subscribe(function(n){t.dispose(),e.mainMenu().selectById(n.fragment)});return Q.when(e.mainMenu().init(e.cfg.mainMenuItems,!1,"").then(function(){return n.makeRelative({moduleId:"viewmodels"}).map(e.cfg.routes).buildNavigationModel().activate()}))},e}();t.MainClass=u,t.cspMain=new u});
define('base/viewmodelBase',["require","exports","base/app"],function(e,t,i){var n=function(){function e(e){this.app=i.cspMain,this.isActivePage=ko.observable(!1),this.modelId=e}return e.prototype.activate=function(){this.isActivePage(!0),this.app.pageModuleId=this.modelId},e.prototype.deactivate=function(){this.isActivePage(!1)},e.prototype.canActivate=function(){return!0},e.prototype.canDeactivate=function(){return!0},e.prototype.attached=function(){return!0},e}();t.ViewModelView=n});
...
var __extends=this.__extends||function(e,t){function n(){this.constructor=e}for(var i in t)t.hasOwnProperty(i)&&(e[i]=t[i]);n.prototype=t.prototype,e.prototype=new n};define('viewmodels/details',["require","exports","base/viewmodelBase"],function(e,t,n){var i=function(e){function t(t){e.call(this,t),this.title=ko.observable(""),this.countries=ko.observableArray(),this.compTitle=ko.computed(function(){return this.title()+" (computed)"},this)}return __extends(t,e),t.prototype.clickUpdatTitle=function(e){this.title(e)},t.prototype.activateToolTips=function(){$(".toolTip").tooltip()},t.prototype.activate=function(){var e=this,t=this;return this.title("My title"),this.app.logger.log("Details View Activated",null,t.modelId,!0),Q.when(t.app.ctx.getCountries(t.countries)).then(function(){return e.activateToolTips(),Q(!0)})},t.prototype.viewAttached=function(){this.activateToolTips()},t}(n.ViewModelView);t.DetailsView=i,t.vm=new i("details"),t.activate=function(){return t.vm.activate()},t.deactivate=function(){return t.vm.deactivate()},t.attached=function(e){return t.vm.viewAttached(e)},t.canActivate=function(){return t.vm.canActivate()},t.canDeactivate=function(){return t.vm.canDeactivate()}});
var __extends=this.__extends||function(e,t){function n(){this.constructor=e}for(var i in t)t.hasOwnProperty(i)&&(e[i]=t[i]);n.prototype=t.prototype,e.prototype=new n};define('viewmodels/home',["require","exports","base/viewmodelBase"],function(e,t,n){var i=function(e){function t(){e.apply(this,arguments),this.title="Home View"}return __extends(t,e),t.prototype.activate=function(){return this.app.logger.log("We are at home now",null,this.modelId,!0),Q.resolve(!0)},t}(n.ViewModelView);t.HomeView=i,t.vm=new i("home"),t.activate=function(){return t.vm.activate()},t.deactivate=function(){return t.vm.deactivate()},t.canActivate=function(){return t.vm.canActivate()},t.canDeactivate=function(){return t.vm.canDeactivate()}});
define('viewmodels/shell',["require","exports","base/app","plugins/router"],function(e,t,n,i){function r(){return n.cspMain.boot()}var o={activate:r,router:i,app:n.cspMain};return o});
define('text',{load: function(id){throw new Error("Dynamic load not allowed: " + id);}});
define('text!views/details.html',[],function () { return '<section>\r\n    <h2 class="page-title" data-bind="text: vm.title"></h2>\r\n    <h3 class="page-title" data-bind="text: vm.compTitle"></h3>\r\n    <button data-bind="click: vm.clickUpdatTitle.bind(vm,\'My new updated title\')">Update the title</button>\r\n    <h2 data-bind="text: \'List of our \'+vm.countries().length+\' countries:\'"></h2>\r\n    <ul data-bind="foreach: vm.countries" style="padding-left: 50px;">\r\n        <li class="toolTip" style="max-width: 200px" data-placement="top" data-toggle="tooltip" data-container="body" data-bind="attr: { \'data-original-title\': toolTip }"><span data-bind="text: id"/><span> - </span><span data-bind="text: name"/></li>\r\n    </ul>\r\n</section>';});

define('text!views/footer.html',[],function () { return '<nav class="navbar navbar-default navbar-fixed-bottom">\r\n    <div class="navbar-inner navbar-content-center">\r\n        <span class="pull-left"><a href="http://johnpapa.net/spa" target="_blank">Learn how to build a SPA </a></span>\r\n        <span class="pull-right hidden-xs"><a href="http://johnpapa.net/hottowel" target="_blank">Hot Towel SPA - © 2013 JohnPapa.net</a></span>\r\n    </div>\r\n</nav>\r\n';});

define('text!views/home.html',[],function () { return '<section>\r\n    <h2 class="page-title" data-bind="text: vm.title"></h2>\r\n</section>';});

define('text!views/nav.html',[],function () { return '<div class="navbar navbar-default" role="navigation">\r\n    <div class="navbar-header">\r\n        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">\r\n            <span class="icon-bar"></span>\r\n            <span class="icon-bar"></span>\r\n            <span class="icon-bar"></span>\r\n        </button>\r\n        <a class="navbar-brand" href="/"><span class="title" data-bind="text: app.appTitle"></span></a>\r\n    </div>\r\n    <div class="navbar-collapse collapse">\r\n        <div class="btn-group" data-bind="foreach: app.mainMenu().itemsList">\r\n            <a data-bind="css: { active: isSelected }, attr: { href: route }, text: name, click: $parent.app.mainMenu().selectItem.bind($parent.app.mainMenu(), $data)" class="btn btn-info" href="#"></a>\r\n        </div>\r\n        <div class="loader pull-right" data-bind="css: { active: app.isLoading }">\r\n            <div class="progress progress-striped active" >\r\n                <div class="progress-bar"  role="progressbar" style="width: 100px;"></div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n\r\n';});
